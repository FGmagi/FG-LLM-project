...
# 可配置的候选列(后端内部使用英文短名)
# 已适配 gen_data.py 生成的新参数名：temp, humidity, rain, solar, soil_water
...
def _summarize_window(df: pd.DataFrame) -> str:
    ...
    lines = []
    # mean temperature (adapted to new key 'temp')
